  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen name="Start" component={Start} options={{ animation: 'fade', gestureEnabled: false }} />
        <Stack.Screen name="GamesTest" component={GamesTest} options={{ animation: 'fade', gestureEnabled: false }} />
        <Stack.Screen name="GameOptions" component={GameOptions} options={{ animation: 'fade', gestureEnabled: false }}/>
        <Stack.Screen name="SplashScreen" component={SplashScreen} options={{ animation: 'fade', gestureEnabled: false }}/>
        <Stack.Screen name="login" component={login} options={{ animation: 'fade', gestureEnabled: false }}/>
        <Stack.Screen name="Cadastro" component={Cadastro} options={{ animation: 'none' }} />
        <Stack.Screen name="Profissional" component={ProfissionalCadastro} options={{ animation: 'none' }}  />
        <Stack.Screen name="ProfileCreate" component={ProfileCreate} options={{ animation: 'ios' }}/>
        ...
        <Stack.Screen name="Stroop" component={Stroop} options={{ animation: 'fade', gestureEnabled: false }}  />
        <Stack.Screen name="StroopInfo" component={StroopInfo} options={{ animation: 'fade_from_bottom', gestureEnabled: false }} />
        <Stack.Screen name="MustSort" component={MustSort} options={{ animation: 'fade', gestureEnabled: false }} />
        <Stack.Screen name="MustSortInfo" component={MustSortInfo}  options={{ animation: 'fade_from_bottom' }} />
        <Stack.Screen name="HiddenColors" component={HiddenColors} options={{ animation: 'fade', gestureEnabled: false }} />
        <Stack.Screen name="HiddenColorsInfo" component={HiddenColorsInfo} options={{ animation: 'fade_from_bottom' }} />
