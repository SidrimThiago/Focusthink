        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.verificationModalView}>
              <Text style={styles.verificationText} className="font-quick-bold">Olá {nomeUser}</Text>
              <Text style={styles.verificationText} ClassName="font-quick-bold pb-10">
              ...
              <Button
                ...
                color="#633DE8"
                className="p-5 font-quick-regular"
              />
            </View>
          </View>
        </Modal>
