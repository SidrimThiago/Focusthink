...
import { View, FlatList, Text, TextInput, StyleSheet, Animated, TouchableHighlight } from "react-native";
...
export default function SearchEspecialist() {
    ...
    const handlePress = React.useCallback(title => {
        console.log(title);
    }, []);
    const Item = React.memo(() => (
        <TouchableHighlight onPress={() => handlePress(title)} activeOpacity={0.8} underlayColor='#6148B6'>
