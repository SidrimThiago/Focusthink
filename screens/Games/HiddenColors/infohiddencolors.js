...
import Icon from '../../../assets/GamesScreen/GamesInfos/HiddenColorsInfo.svg'

export default function HiddenColorsInfo() {
                    ...
                    <View style={{ padding: 20, alignItems: 'center' }}>
                        <View style={{ marginTop: 170, alignSelf: 'flex-start' }}>
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <TouchableOpacity onPress={() => navigation.navigate('Countdown', { jogo: 'HiddenColors' })} style={{ height: 45, width: 175, backgroundColor: '#FF6F20', borderRadius: 5, alignItems: 'center', justifyContent: 'center', marginRight: 12 }}>
                                    <Text style={{ fontSize: 29, color: 'white', fontFamily: 'Quicksand-Bold', bottom: 4 }}>Jogar</Text>
                                </TouchableOpacity>
                                <View style={{ width: 100, height: 32, backgroundColor: '#F92BDC', alignItems: 'center', justifyContent: 'flex-start', borderRadius: 40 }}>
                                    <Text style={{ fontSize: 15, color: 'white', fontFamily: 'Quicksand-Medium', marginTop: 3 }}>Raciocínio</Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <Text style={{ fontSize: 17, color: 'white', fontFamily: 'Quicksand-Regular', marginTop: 25 }}>Este jogo desafia os jogadores a adivinhar a 
                            sequência correta de cores apresentadas. Os jogadores devem deduzir as cores e sua ordem através de tentativas, recebendo feedback após cada 
                            tentativa para ajustar suas próximas escolhas. Além de oferecer uma experiência divertida e desafiadora, esse tipo de jogo pode melhorar a 
                            memória de trabalho, estimular a capacidade de resolução de problemas e a lógica dos jogadores.
                        </Text>
