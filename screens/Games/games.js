    ...
    <SafeAreaView style={styles.container}>
      <LinearGradient colors={['#633DE8', '#1C233F']} style={styles.background}>
        ...
        <ScrollView
          ...
          style={{ padding: 10, paddingTop: 0, width: '100%' }}
        ...
        >
          ...
          <View style={styles.categorias}>
            <Text style={[styles.categorygame, { color: '#9DFF51' }]}>
              Coordenação
            </Text>
            ...
            >
              <Pressable
                style={styles.pressable}
                onPress={() => navigation.navigate('MustSortInfo')}
              >
                <Image
                  source={require('../../assets/GamesScreen/GamesIcons/MustSort.png')}
                  style={styles.iconGame}
                />
          ...
          <View style={styles.categorias}>
            ...
            >
              <Pressable
                style={styles.pressable}
                onPress={() => navigation.navigate('HiddenColorsInfo')}
              >
                <Image
                  source={require('../../assets/GamesScreen/GamesIcons/HiddenColors.png')}
                  style={styles.iconGame}
                />
