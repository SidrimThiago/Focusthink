...
import { StyleSheet, View, Text, Animated, Easing, SafeAreaView, Pressable, Image, ScrollView, Button} from 'react-native'
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Button onPress={() => navigation.navigate('Teste')} title='Teste'/>
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={{ padding: 10, paddingTop: 0 }} >
          ...
          <View style={styles.categorias}>
            <Text style={[styles.categorygame, { color: '#9DFF51' }]}>Coordenação</Text>

            <ScrollView style={{ flex: 1 }} horizontal={true} showsHorizontalScrollIndicator={false}>
              <Pressable style={styles.pressable} onPress={() => navigation.navigate('MustSort')}>
                <View style={[styles.empty, { backgroundColor: 'green' }]} />
                <Text style={[styles.vazio, { width: 100, color: 'black' }]}>Must Sort</Text>
              </Pressable>
              <Pressable style={styles.pressable}>
                <View style={styles.empty} />
                <Text style={styles.vazio}>Vazio</Text>
